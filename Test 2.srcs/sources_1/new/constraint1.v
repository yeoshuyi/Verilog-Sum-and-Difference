...
module circuit(
    ...
    wire [2:0] signedDiff; //Is sum2 if A>B else diff
    ...
    assign signedDiff[0] = sum2[3] ? diff[0] : sum2[0];
    assign signedDiff[1] = sum2[3] ? diff[1] : sum2[1];
    assign signedDiff[2] = sum2[3] ? diff[2] : sum2[2];
        
    assign LED0 = BTN0 ? signedDiff[0] : sum[0];
    assign LED1 = BTN0 ? signedDiff[1] : sum[1];
    assign LED2 = BTN0 ? signedDiff[2] : carry[1];
